...
<?php 
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $catt_id = mysqli_real_escape_string($connection,$_POST['catt_id']);
                        $catt_name = mysqli_real_escape_string($connection,$_POST['catt_name']);
                         
                        $query = "UPDATE category SET category_id = '{$catt_id}', category_name = '{$catt_name}' WHERE category_id= '{$catt_id}' ";
...
<div class="container">
        ...
        ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="catt_id" value="<?php echo $row['category_id'] ?>" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Category Name</label>
                                <input name="catt_name" value="<?php echo $row['category_name'] ?>" type="text" class="form-control" id="exampleInputPassword1">
                            </div>
