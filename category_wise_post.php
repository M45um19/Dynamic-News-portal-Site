...
<body class="body_col">
    ...
    <?php
        ...
        WHERE post.category = '{$category_of_post}'
        ...
        <div class="news">
            ...
            <div class="post_details">
                <div class="">
                    ...
                    <a class="custom_link" href=""><?php echo $row['category_name'] ?></a>
                </div>
                <div class="details">
    ...
    <form action="search.php" method="GET" class="d-flex mt-1 p-3">
      ...
      <?php
        ...
        include "admin/configure.php";
        $query1 = "SELECT * FROM post WHERE category = '{$category_of_post}' ORDER BY post_id DESC LIMIT 0,5";
